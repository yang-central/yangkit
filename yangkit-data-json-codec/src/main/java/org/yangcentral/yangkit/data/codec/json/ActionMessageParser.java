...
public class ActionMessageParser {
    ...
    public ActionMessageParser(YangSchemaContext schemaContext) {
     ...
     * @return
     */
    public YangDataDocument parseInput(AbsolutePath path, JsonNode input, ValidatorResultBuilder validatorResultBuilder) {
    ...
    public ValidatorResult parseOutPut(YangDataDocument rpcDoc, AbsolutePath Path,JsonNode output){
